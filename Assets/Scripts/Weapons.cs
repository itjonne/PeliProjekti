    ...
    */
    ...
    private void Update()
    {
       ...
       */
        ...
        if (Input.GetKey(KeyCode.R) && ammoLeft != magSize) //Muutettu että täyttä pyssyä ei voi ladata -Ossi
        {
            StartCoroutine(Reload());
        ...
        //Tarkempi paikaltaan mutta ei kuitenkaan täysin hajonnaton
        //Bullets to shoot häkkyrä -> koitetaan saada haulikolle samanlainen hajonta paikaltaan ja liikkeestä
        //Aika purkka ratkaisu tällä hetkellä - OSSI
